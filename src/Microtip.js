...
import microtipBundle from './assets/microtip_bundle.png';
import microtipOptions from './assets/microtip_options.png'

class Microtip extends Component{
 
render() {
return(  <div>
    <h3 style={{textAlign:"center"}}><a target="_blank" href="https://www.npmjs.com/package/microtip">Microtip</a></h3>
    <div className="imageContainer">
      <img src={microtipBundle} alt="microtip" />
    </div>
    <div className="imageContainer">
      <img src={microtipOptions} alt="microtip" />
    </div>
    ...
    <div style={{width:"100%", margin:"10px auto 10px auto", backgroundColor:"lightgrey"}}>
        <div>
              <span className="sup" data-microtip-size="medium" data-microtip-position="top-right" role="tooltip" aria-label="Growth rates for orders, revenues and order backlog are on a comparable basis (local currency adjusted for acquisitions and divestitures), previously referred to as ‘like-for-like’. US$ growth rates are presented in Key Figures table" style={{color:"red"}} >1</span>test
          </div>
         <div style={{textAlign:"center"}}>test
              <span className="sup" data-microtip-size="large" data-microtip-position="top-right" role="tooltip" aria-label="Growth rates for orders, revenues and order backlog are on a comparable basis (local currency adjusted for acquisitions and divestitures), previously referred to as ‘like-for-like’. US$ growth rates are presented in Key Figures table" style={{color:"red"}}>2</span>test
        </div>
